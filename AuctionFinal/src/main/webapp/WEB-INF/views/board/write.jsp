...
<div style="padding-left: 10%; margin-bottom: 0.2%; border: solid 0px red;">
	<h1>게시판 글쓰기</h1>
		...
		<!-- # 134. 파일 첨부하기  
					먼저  <form name="writeFrm"> 을 주석처리 후 다음과 같이 작업을 수행한다. 
					enctype="multipart/form-data"를 해주어야 파일첨부가 된다.-->
	<%-- <form name="writeFrm">  --%>
...
if(window.frameElement){
	...
	var oEditor = createSEditor2(jindo.$("content"), {
	...
	function setDefaultFont() {
		...
		oEditor.setDefaultFont(sDefaultFont, nFontSize);
            	...
            	<!-- _________________________________스마트에디터 끝_________________________________ -->
            	</td>
         	</tr>
